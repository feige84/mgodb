...
type Runner struct {
	tc   *mg.Collection // txns
	sc   *mg.Collection // stash
	lc   *mg.Collection // log
...
func NewRunner(tc *mg.Collection) *Runner {
	return &Runner{
		tc:   tc,
...
// Resume resumes the transaction with Id. It returns mg.ErrNotFound
...
func (r *Runner) ChangeLog(logc *mg.Collection) {
	r.lc = logc
}
